...
def compute_trajectory(
    ...
    # ecc_results[i].warp_matrix (from findTransformECC(template=prev, input=curr))
    ...
    warp_by_pair: dict[tuple[int, int], np.ndarray] = {
        (r.prev_idx, r.curr_idx): r.warp_matrix for r in ecc_results
    }
