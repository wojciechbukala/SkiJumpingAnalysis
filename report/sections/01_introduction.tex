...
\begin{itemize}
    ...
    \item \textbf{Kalman filtering} - Applied to the detected center-of-mass sequence to reduce frame-to-frame jitter and obtain a smoother 2D trajectory before geometric processing.
    ...
    \item \textbf{Savitzky-Golay smoothing} - Applied as a final smoothing step to reduce residual noise in the reconstructed trajectory.
